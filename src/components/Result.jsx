export default function ResultCard({height,width,mobileWidth,mobileHeight}) {
    return(
        <>
          <div className={`font-custom rounded-bl-[40px] rounded-br-[40px] xl:rounded-2xl xl:w-1/2  bg-gradient-to-b from-slateBlue to-lightRoyalBlue xl:h-full ${width} flex items-center ${mobileWidth} ${mobileHeight}`}>
            <div className="flex flex-col items-center h-[90%]  justify-around">
             ...
             <div className="flex flex-col items-center">
                ...
                <p className="w-[70%] xl:w-[60%] text-center text-lightLavender">You scored higher than 65% of the people who have taken these  tests</p>
             </div>
            </div>
          </div>
        </>
