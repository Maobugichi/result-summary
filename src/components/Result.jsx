export default function ResultCard({height,width,mobileWidth,mobileHeight}) {
    return(
        <>
          <section aria-labelledby="text-head" className={`font-custom rounded-bl-[40px] rounded-br-[40px] xl:rounded-2xl xl:w-1/2  bg-gradient-to-b from-slateBlue to-lightRoyalBlue xl:h-full ${width} flex items-center ${mobileWidth} ${mobileHeight} md:h-full md:rounded-2xl`}>
            <div className="flex flex-col items-center h-[90%]  justify-around">
             ...
             <div className="flex flex-col items-center">
                <h2 id="text-head" className="text-3xl mb-4 font-bold text-white ">Great</h2>
